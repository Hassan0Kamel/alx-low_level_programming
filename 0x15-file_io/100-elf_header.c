 ...
 * @e_ident: itt's a pointer to an array
 */
 ...
 * @e_ident: a pointeer to an arrayy contains the ELF version
 */
 ...
 * @e_ident: pointerrr to arrayyy containining ELF ABI ver
 */
...
/**
 * print_type - printing the type if an ELF header
 * @e_type: The ELF type
 ...
 * @e_ident: the pointer has ELF class
 */
